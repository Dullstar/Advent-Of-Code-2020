...
def find_earliest_departure_time(timestamp: int, _bus_ids: list):
    ...
    print(f"The earliest departure is bus {busses[0].id} at time {busses[0].next_departure}")
...
def id_problem(bus_ids: list):
    ...
    print("The busses align in the requested manner at ", start_val)
...
def main():
    timestamp, bus_ids = parse_input("input.txt")
